...
VALUES
    ...
    (4, (SELECT parameter_definition_id FROM parameter_definitions WHERE parameter_name = 'query_parameters'), '{"geo": "DE"}', false),
...
VALUES
    ...
    (5, (SELECT parameter_definition_id FROM parameter_definitions WHERE parameter_name = 'query_parameters'), '{"geo": "FR"}', false),
...
VALUES
    ...
    (6, (SELECT parameter_definition_id FROM parameter_definitions WHERE parameter_name = 'query_parameters'), '{"geo": "IN"}', false),
...
VALUES
    ...
    (7, (SELECT parameter_definition_id FROM parameter_definitions WHERE parameter_name = 'query_parameters'), '{"geo": "RU"}', false),
...
VALUES
    ...
    (8, (SELECT parameter_definition_id FROM parameter_definitions WHERE parameter_name = 'query_parameters'), '{"geo": "BR"}', false),
...
VALUES
    ...
    (9, (SELECT parameter_definition_id FROM parameter_definitions WHERE parameter_name = 'query_parameters'), '{"geo": "AU"}', false),
...
VALUES
    ...
    (10, (SELECT parameter_definition_id FROM parameter_definitions WHERE parameter_name = 'query_parameters'), '{"geo": "TR"}', false),
